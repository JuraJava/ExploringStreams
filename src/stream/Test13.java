/**
 * Задача:
 * Дан список строк. Нужно:
 * Отфильтровать только строки, содержащие цифры
 * Преобразовать каждую строку в список символов
 * Оставить только цифровые символы
 * Преобразовать каждый символ в число
 * Убрать дубликаты чисел
 * Отсортировать по убыванию
 * Собрать в строку, разделенную запятыми
 */
